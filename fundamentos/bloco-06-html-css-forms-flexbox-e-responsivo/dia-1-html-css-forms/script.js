...
function href(eventHref){
    eventHref.preventDefault();
}
...
*/
function inputCheckbox (eventCheckbox){
...
function inputText (eventInputText){
    eventInputText.preventDefault();
    let a = eventInputText.key;
    if(a == 'a'){
        letraA.innerHTML = "você apertou a letra: " + a;
    }
}
